...
function makeHeader(blog_username, username){
    ...
    header_body += '<h1 class="logo"><a href="/index.html"> ' + decodeURI(blog_username) + '的主页</a></h1>';
    header_body += '<li><a href="/index.html">网站首页</a></li>';
    header_body += '<li>';
    header_body += '<a href=' + '"' + user_topics_url + '"' + '>学员快报</a>';
    header_body += '<ul class="sub-nav">';
    header_body += '<li><a href=' + '"' + user_topics_url + '?category=tec"' + '>知识分享</a></li>';
    header_body += '<li><a href=' + '"' + user_topics_url + '?category=no-tec"' + '>感悟分享</a></li>';
    header_body += '</ul>';
    header_body += '</li>';
    header_body += '<li><a href=/' + username + '/change_password>安全设置</a> </li>';
    header_body += '<li><a href=' + '"' + user_info_url + '"' + '>学院介绍</a> </li>';
    header_body += '<li><a href=' + '"' + topic_release_url + '"' + '>感悟分享</a> </li>';
    header_body += '</nav>';
    header_body += '</div>';
    if (username){
