"""
Django settings for tile_server project.
...
SECRET_KEY = 'pn59q-1fr^did9d!&q^v5!-g&faueyj8!nqp5z94kw7=pgs7y+'
...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware',  # wdb
...
WSGI_APPLICATION = 'tile_server.wsgi.application'
